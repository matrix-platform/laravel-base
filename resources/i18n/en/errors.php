...
return [
    ...
    'invalid-message-driver' => 'Invalid message driver configuration',

    'invalid-message-provider' => 'Invalid message provider configuration',

    'invalid-message-receiver' => 'Message receiver must not be empty',
