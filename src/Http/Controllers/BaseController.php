...
abstract class BaseController extends Controller {
    ...
    public function callAction($method, $parameters) {
        try {
            ...
            return ['success' => false, 'code' => 404, 'error' => 'data-not-found', 'message' => i18n('errors.data-not-found')];
        } catch (ServiceException $exception) {
            return ['success' => false, 'code' => $exception->getCode(), 'error' => $exception->getError(), 'message' => $exception->getMessage()];
        } catch (ValidationException $exception) {
            return ['success' => false, 'code' => 422, 'errors' => array_map(array_keys(...), $exception->validator->failed())];
        }
    }
