...
| POST | `admin/city/{id}/copy` | 授權 |
| POST | `admin/city/delete` | 授權 |
| POST | `admin/city/export` | 授權 |
| POST | `admin/city/sort` | 授權 |
| POST | `admin/city/sort/save` | 授權 |
| POST | `admin/city/arrange` | 授權 |
| POST | `admin/city/arrange/save` | 授權 |
...
| POST | `admin/city/{city_id}/area/{id}/copy` | 授權 |
| POST | `admin/city/{city_id}/area/delete` | 授權 |
| POST | `admin/city/{city_id}/area/export` | 授權 |
